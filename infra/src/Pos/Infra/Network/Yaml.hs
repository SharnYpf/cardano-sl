...
instance ToJSON NodeMetadata where
    toEncoding
        (NodeMetadata
            ...
            nmPublicDNS
            nmMaxSubscrs) = do
                case (nmAddress, nmMaxSubscrs) of
                    (NodeAddrExact ip (Just port), OQ.BucketSizeMax int) ->
                        A.pairs $
                         ...
                         <>  A.pairStr "maxSubscrs" (toEncoding int)
                    (NodeAddrExact ip (Just port), OQ.BucketSizeUnlimited) ->
                        A.pairs $
                             A.pairStr "type" (toEncoding nmType)
                         <>  A.pairStr "region" (toEncoding nmRegion)
                         <>  A.pairStr "static-routes" (toEncoding nmRoutes)
                         ...
                         <>  A.pairStr "kademlia" (toEncoding nmKademlia)
                         <>  A.pairStr "public" (toEncoding nmPublicDNS)
                         <>  A.pairStr "maxSubscrs" (A.null_)
                    (NodeAddrExact ip Nothing, OQ.BucketSizeMax int) ->
                        A.pairs $
                             A.pairStr "type" (toEncoding nmType)
                         <>  A.pairStr "region" (toEncoding nmRegion)
                         <>  A.pairStr "static-routes" (toEncoding nmRoutes)
                         ...
                         <>  A.pairStr "public" (toEncoding nmPublicDNS)
                         <>  A.pairStr "maxSubscrs" (toEncoding int)
                    (NodeAddrExact ip Nothing, OQ.BucketSizeUnlimited) ->
                        A.pairs $
                            A.pairStr "type" (toEncoding nmType)
                         <> A.pairStr "region" (toEncoding nmRegion)
                         <> A.pairStr "static-routes" (toEncoding nmRoutes)
                         ...
                         <> A.pairStr "public" (toEncoding nmPublicDNS)
                         <> A.pairStr "maxSubscrs" A.null_
                    (NodeAddrDNS (Just host) (Just port)
                     , OQ.BucketSizeMax int) -> do
